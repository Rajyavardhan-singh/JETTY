  ...
  if (user) {
    ...
    if (ships) {
      ...
      for (const s of ships) {
        ...
        if (!s.sign_off_date) {
          // Active voyage — count days towards sea time but NOT towards vessels sailed
      ...
      // Vessels SAILED = only completed (sign_off_date not null)
          ...
          {user ? (
            <>
              ...
              <div className={styles.heroContent}>
                ...
                <div>
                  ...
                  {!profile?.full_name && (
                    <Link href="/profile" className={styles.heroCompleteBtn} style={{ display: "inline-flex", alignItems: "center", gap: "0.25rem" }}>
                      Complete your profile <span className="msi msi-sm" style={{ verticalAlign: "middle" }}>arrow_forward</span>
                    </Link>
                  )}
                </div>
              </div>
            ...
            <div className={styles.heroContent}>
              <div className={styles.heroLogo}>
                <span className="msi" style={{ fontSize: "3.5rem", color: "var(--primary)", fontVariationSettings: "'FILL' 1, 'wght' 300, 'GRAD' 0, 'opsz' 48" }}>anchor</span>
              </div>
              <div>
