...
// -- All modules — shown/hidden conditionally based on auth state ---------------
const ALL_MODULES = [
  { icon: "directions_boat", title: "Sailing History", sub: "Manage past voyages", href: "/sailing-history", ready: true, authRequired: true },
  { icon: "description", title: "Documents", sub: "Certificates & Licences", href: "/documents", ready: true, authRequired: true },
  { icon: "quiz", title: "Exams", sub: "Preparation & Results", href: "/exams", ready: false, authRequired: false },
  { icon: "shopping_cart", title: "Shop", sub: "Maritime Gear & Tools", href: "/shop", ready: false, authRequired: false },
  { icon: "business_center", title: "Jobs", sub: "Crewing Opportunities", href: "/jobs", ready: false, authRequired: false },
  { icon: "policy", title: "DG Shipping", sub: "Compliance & Profile", href: "/dg-shipping", ready: true, authRequired: false },
  { icon: "menu_book", title: "Manuals", sub: "Technical References", href: "/manuals", ready: false, authRequired: true },
  { icon: "calculate", title: "Sea Time Calculator", sub: "Calculate Your Sea Service", href: "/seatime", ready: true, authRequired: false },
  { icon: "receipt_long", title: "NRI Tax Filing", sub: "Tax Planning for Mariners", href: "/nri-tax", ready: false, authRequired: true },
];
...
export default async function HomePage() {
  ...
  // Filter modules based on auth state
  const MODULES = ALL_MODULES.filter(m => user ? true : !m.authRequired);
            ...
            <>
              ...
              <div className={styles.heroContent}>
                <div className={styles.heroText}>
                  ...
                  {!profile?.full_name && (
                    <Link href="/profile?edit=true" className={styles.heroCompleteBtn}>
              ...
              <div className={styles.heroRight}>
                ...
                <Link href="/currency" className={styles.currencyLink}>
                  <CurrencyWidget />
                </Link>
              </div>
            </>
            ...
            <>
              <div className={styles.heroContent}>
                <div className={styles.heroLogo}>
                  <span className="msi" style={{ fontSize: "inherit", color: "var(--primary)", fontVariationSettings: "'FILL' 1, 'wght' 300, 'GRAD' 0, 'opsz' 48" }}>anchor</span>
                </div>
                <div className={styles.heroText}>
