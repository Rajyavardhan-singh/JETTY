...
export default function StcwCard({ indosNumber, dateOfBirth }: StcwCardProps) {
    ...
    <>
      <div className={styles.interactiveCard} onClick={handleClick}>
        ...
        <p className={styles.cardDesc}>
          View, download, and dynamically verify your professional STCW course certificates and records.
        </p>
