          ...
          <div className={styles.drawerProfileInfo}>
            {user ? (
              ...
              <>
                ...
                <Link href="/login" className={styles.completeProfileBtn} onClick={() => setDrawerOpen(false)} style={{ display: "inline-flex", alignItems: "center", gap: "0.25rem" }}>Log In <span className="msi msi-sm" style={{ verticalAlign: "middle" }}>arrow_forward</span></Link>
              </>
            )}
          </div>
        </Link>
