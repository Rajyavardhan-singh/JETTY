    ...
    <AppShellServer>
      ...
      <main className={styles.main}>
        ...
        <header className={styles.hero}>
          ...
          <Link href={`/sailing-history/${id}/edit`} className={styles.editBtnHero}>✎ Edit Entry</Link>
        </header>
        ...
        <div className={styles.bentoGrid}>
          ...
          <div className={styles.rightCol}>
            ...
            {personnel.length > 0 && (
              <div className={styles.card}>
                <h3 className={styles.cardTitle}><span className={styles.cardIcon}>👥</span> Senior Officers</h3>
          ...
          {documents.length > 0 && (
            <div className={`${styles.card} ${styles.fullWidth}`}>
              <h3 className={styles.cardTitle}>
                ...
                <span className={styles.cardTitleSub}> — Contract, Ship Particulars, Appraisals</span>
              </h3>
