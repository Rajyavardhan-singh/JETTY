...
export default function ProfileClient({ profile, user }: Props) {
  ...
  const displayNameWithPrefix = prefix ? `${prefix} ${displayName}` : displayName;
      ...
      <div className={styles.contentArea}>
          ...
          <section className={styles.heroSection}>
            ...
            <div className={styles.heroAvatarWrapper}>
              ...
              />
              {/* Camera overlay — always visible so user can change pic */}
              <button
              ...
              >
                {uploading ? (
                  <span className="msi msi-sm">hourglass_top</span>
                ) : (
                  <span className="msi msi-sm">photo_camera</span>
                )}
              </button>
            </div>
                ...
                {isEditing ? (
                  <>
                    <button className={styles.editBtn} onClick={handleSave} disabled={saving}>
                      <span className="msi msi-sm">save</span> {saving ? "Saving..." : "Save Profile"}
                    </button>
                    <button
            ...
            <div className={`${styles.card} ${styles.cardSpan2}`}>
              ...
              <div className={styles.gridData}>
                ...
                <div className={styles.dataItem}>
                  ...
                  {isEditing ? (
                    <input className={styles.editInput} value={form.indos_number || ""} onChange={(e) => handleChange("indos_number", e.target.value)} placeholder="e.g. IND-224590-X" />
                  ) : (
                ...
                <div className={styles.dataItem}>
                  ...
                  {isEditing ? (
                    <input className={styles.editInput} value={form.passport_number || ""} onChange={(e) => handleChange("passport_number", e.target.value)} placeholder="e.g. Z-44920192" />
                  ) : (
