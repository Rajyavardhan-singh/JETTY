...
export default async function DGShippingPage() {
  ...
  // No redirect — page is open to all users
  let profile: { indos_number: string | null; date_of_birth: string | null } | null = null;
  if (user) {
      ...
      <div className={styles.page}>
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Centralized access to the Directorate General of Shipping resources, E-Learning, and real-time maritime regulatory updates.
          </p>
        </div>
        ...
        <div className={styles.grid}>
          ...
          <a href="https://dgma.gov.in/" target="_blank" rel="noopener noreferrer" className={`${styles.card} ${styles.staticCard}`}>
            ...
            <p className={styles.cardDesc}>
              Official portal for all national maritime policies and administrative resources.
            </p>
          ...
          {/* Dynamic STCW Certificate Component — behaviour changes based on login */}
          <StcwCard
          ...
          <a href="http://220.156.189.33/esamudraUI/well.do?method=loadPage" target="_blank" rel="noopener noreferrer" className={`${styles.card} ${styles.staticCard}`}>
            ...
            <p className={styles.cardDesc}>
              Manage your Account, Exam applications, update seafarer&apos;s profile .
            </p>
            <span className={styles.cardAction}>
          ...
          <a href="https://www.dgshipping.gov.in/news.aspx" target="_blank" rel="noopener noreferrer" className={`${styles.card} ${styles.staticCard}`}>
            ...
            <p className={styles.cardDesc}>
              Latest updates, general alerts, and training directives.
            </p>
            <span className={styles.cardAction}>
